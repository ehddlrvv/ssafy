...
slack_client_secret = "fb374ba5f48acae229041ec2c41b03eb"
...
def get_answer(text, user_key):
    ...
    data_header = {
        'Authorization': 'Bearer 7cb5ed9a9e234d4b8b11b52ab8d2db80',
...
def _crawl_naver_keywords(text):
    # 자연어 처리 결과를 가져옴
    dialog_result = get_answer(text, 'session')

    if dialog_result == "bugs":
        keywords = []
        ...
        for bugs_text in soup.find_all('p', class_="title"):
            titles.append(bugs_text.get_text().replace("\n", ""))
